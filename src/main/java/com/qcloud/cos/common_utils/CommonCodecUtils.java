...
public class CommonCodecUtils {
    ...
    public static String Base64Encode(byte[] binaryData) {
        String encodedstr = new String(Base64.encodeBase64(binaryData, false));
        return encodedstr;
    }
    ...
    public static String getBufferSha1(byte[] contentBuffer) throws Exception {
        return DigestUtils.shaHex(contentBuffer);
    }
    ...
    public static String getEntireFileSha1(String filePath) throws Exception {
        ...
        try {
            ...
            String sha1Digest = DigestUtils.shaHex(fileInputStream);
            return sha1Digest;
        } catch (Exception e) {
     ...
     * 除最后一片外，每一片的sha信息都是中间状态,即sha算法update后的五个常量值的十六进制字符串
     * 因此最后一片的sha值和全文sha是一样的
     ...
     * @throws Exception           
     */
    public static String getSlicePartSha1(String localPath,
                                          int sliceSize,
