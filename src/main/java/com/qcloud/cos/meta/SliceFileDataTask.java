...
public class SliceFileDataTask implements Callable<JSONObject> {
	...
	public SliceFileDataTask(int taskId, int sliceIndex, SliceCheckPoint scp, UploadSliceFileContext context,
	...
	public String toString() {
		...
		sb.append("TaskId:").append(TaskId).append(", SliceIndex:").append(sliceIndex).append(", localPath:")
				.append(context.getLocalPath()).append(", uploadUrl:").append(this.url);
		return sb.toString();
	}
}
